...
usuario.addEventListener('keyup', () => {
    if (usuario.value.length <= 5) {
        ...
        labelUsuario.innerHTML = 'Insira no minimo 6 caracteres'
...
function cadastrar() {
    ...
    if (checkBox.checked) {
        ...
        if (validNome && validUsuario && validSenha && validConfirmSenha && validCpf && validEmail) {
            ...
            msgSuccess.innerHTML = '<strong>Usuario Cadastrado com Sucesso...</strong>'
            msgError.setAttribute('style', 'display: none')
            msgError.innerHTML = ''

            setTimeout(() => {
                window.location.href = 'https://developer.mozilla.org/pt-BR/docs/Web/HTML/Element/html'
            }, 3000)
        ...
        alert('Primeiro aceite os termos de condição');
    }
}
